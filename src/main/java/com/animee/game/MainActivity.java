...
//    定义计数时间的变量
    int time = 0;
//    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.img_cola_00x00,R.mipmap.img_cola_00x01,R.mipmap.img_cola_00x02,
        R.mipmap.img_cola_01x00,R.mipmap.img_cola_01x01,R.mipmap.img_cola_01x02,
        R.mipmap.img_cola_02x00,R.mipmap.img_cola_02x01,R.mipmap.img_cola_02x02};
